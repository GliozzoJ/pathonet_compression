...
#J: Modified to be compatible with TF2
...
def FCRN_A(input_dim, classes=3, pretrained_weights = None):
    ...
    model = Model (input_, density_pred)
...
def PathoNet(input_size = (256,256,3), classes=3, pretrained_weights = None):
    ...
    #model.summary() #J: Removed to avoid long print on screen of model summary every time I call evaluation.eval()
